      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info">
            ...
            <p class="attr" v-for="info in skuInfo.skuSaleAttrValueList" :key="info.saleAttrId">{{info.saleAttrName}} : {{info.saleAttrValueName}}</p>
        ...
        <div class="right-gocart">
          ...
          <!-- <a @click="goShopCart(skuInfo.skuSaleAttrValueList)">去购物车结算 > </a> -->
